    ...
    <div class="bg-gradient-to-br from-cyan-400/20 via-blue-500/15 to-indigo-600/20 backdrop-blur-xl p-4 sm:p-6 rounded-2xl sm:rounded-3xl shadow-2xl border border-cyan-300/30 mb-4 sm:mb-6">
      <div class="grid grid-cols-4 sm:grid-cols-4 lg:grid-cols-8 gap-3">
        <div class="text-center transition-all duration-300 transform hover:scale-105">
          ...
          <Link href="/service" class="block text-slate-700 text-xs sm:text-sm font-medium hover:text-slate-900 transition-colors drop-shadow-sm">{{ t('Service') }}</Link>
        </div>
        <div class="text-center transition-all duration-300 transform hover:scale-105">
          ...
          <Link href="/event" class="block text-slate-700 text-xs sm:text-sm font-medium hover:text-slate-900 transition-colors drop-shadow-sm">{{ t('Event') }}</Link>
        </div>
        <div class="text-center transition-all duration-300 transform hover:scale-105">
          ...
          <Link :href="route('withdraw')" class="block text-slate-700 text-xs sm:text-sm font-medium hover:text-slate-900 transition-colors drop-shadow-sm">{{ t('Withdraw') }}</Link>
        </div>
        <div class="text-center transition-all duration-300 transform hover:scale-105">
          ...
          <Link href="/deposit" class="block text-slate-700 text-xs sm:text-sm font-medium hover:text-slate-900 transition-colors drop-shadow-sm">{{ t('Deposit') }}</Link>
        </div>
        <div class="text-center transition-all duration-300 transform hover:scale-105">
          ...
          <Link href="/terms" class="block text-slate-700 text-xs sm:text-sm font-medium hover:text-slate-900 transition-colors drop-shadow-sm">{{ t('T&C') }}</Link>
        </div>
        <div class="text-center transition-all duration-300 transform hover:scale-105">
          ...
          <Link href="/certificate" class="block text-slate-700 text-xs sm:text-sm font-medium hover:text-slate-900 transition-colors drop-shadow-sm">{{ t('Certificate') }}</Link>
        </div>
        <div class="text-center transition-all duration-300 transform hover:scale-105">
          ...
          <Link href="/faqs" class="block text-slate-700 text-xs sm:text-sm font-medium hover:text-slate-900 transition-colors drop-shadow-sm">{{ t('FAQs') }}</Link>
        </div>
        <div class="text-center transition-all duration-300 transform hover:scale-105">
          ...
          <Link href="/about" class="block text-slate-700 text-xs sm:text-sm font-medium hover:text-slate-900 transition-colors drop-shadow-sm">{{ t('About') }}</Link>
        </div>
      </div>
    </div>
