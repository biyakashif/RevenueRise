      ...
      <div class="bg-gradient-to-br from-cyan-400/20 via-blue-500/15 to-indigo-600/20 backdrop-blur-xl p-3 sm:p-6 rounded-2xl sm:rounded-3xl shadow-2xl border border-cyan-300/30 mt-4 sm:mt-6">
        <div class="flex items-center justify-between gap-2">
          <div class="flex items-center gap-2 sm:gap-4 min-w-0">
            ...
            <div class="min-w-0">
              <h3 class="text-sm sm:text-lg font-bold text-slate-800 drop-shadow-sm">Invite Friends</h3>
              <p class="text-[10px] sm:text-sm text-slate-600 font-medium">Share and earn rewards</p>
            </div>
          </div>
      ...
      <div v-if="showShareModal" class="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4" @click="closeShareModal">
        <div class="bg-white/95 backdrop-blur-xl rounded-3xl p-5 sm:p-6 max-w-sm w-full shadow-2xl border border-white/40 max-h-[90vh] overflow-y-auto" @click.stop>
          <div class="text-center mb-4 sm:mb-6">
            <h3 class="text-base sm:text-lg font-bold text-slate-800 mb-1 sm:mb-2">Share Invite Link</h3>
            <p class="text-xs sm:text-sm text-slate-600">Invite friends and earn rewards</p>
          </div>
